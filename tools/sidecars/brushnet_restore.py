...
from no_watermar.provider_workers import restore_with_brushnet


def main() -> int:
    parser = argparse.ArgumentParser(description="BrushNet restore sidecar.")
