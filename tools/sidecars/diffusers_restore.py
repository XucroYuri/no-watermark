...
from no_watermar.provider_workers import restore_with_diffusers_inpaint


def main() -> int:
    parser = argparse.ArgumentParser(description="Diffusers inpaint sidecar restore provider.")
    ...
    result = restore_with_diffusers_inpaint(
        image,
        mask,
        prompt=args.prompt,
