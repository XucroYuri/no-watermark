...
- `build-release.ps1`: install the editable package with release tooling, run the CLI smoke check, run tests, capture disposable stable evidence, build wheel and sdist artifacts, and run `twine check`
